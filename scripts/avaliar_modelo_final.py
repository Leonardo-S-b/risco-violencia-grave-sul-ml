...
ARQUIVO_PREVISOES = Path("data/processed/previsoes_teste_modelo_final.csv")
ARQUIVO_MODELO = Path("models/modelo_risco_violencia_grave.joblib")
RELATORIO_TEXTO = Path("reports/resumo_avaliacao_modelo_final.txt")
RELATORIO_JSON = Path("reports/metricas_avaliacao_modelo_final.json")
