...
RELATORIO_TEXTO = Path("reports/experimentos/resumo_comparacao_perfis_municipios.txt")
RELATORIO_JSON = Path("reports/experimentos/metricas_comparacao_perfis_municipios.json")
