...
RELATORIO_TEXTO = Path("reports/versoes/maximo_movel_6m/resumo_analise_limiares.txt")
RELATORIO_JSON = Path("reports/versoes/maximo_movel_6m/metricas_analise_limiares.json")
