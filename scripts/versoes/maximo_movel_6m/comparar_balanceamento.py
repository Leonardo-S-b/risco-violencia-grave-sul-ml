...
RELATORIO_TEXTO = Path("reports/versoes/maximo_movel_6m/resumo_comparacao_balanceamento.txt")
RELATORIO_JSON = Path("reports/versoes/maximo_movel_6m/metricas_comparacao_balanceamento.json")
