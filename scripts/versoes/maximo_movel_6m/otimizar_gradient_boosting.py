...
RELATORIO_TEXTO = Path("reports/versoes/maximo_movel_6m/resumo_otimizacao_gradient_boosting.txt")
RELATORIO_JSON = Path("reports/versoes/maximo_movel_6m/metricas_otimizacao_gradient_boosting.json")
