...
RELATORIO_TEXTO = Path("reports/versoes/maximo_movel_6m/resumo_otimizacao_regressao_logistica.txt")
RELATORIO_JSON = Path("reports/versoes/maximo_movel_6m/metricas_otimizacao_regressao_logistica.json")
