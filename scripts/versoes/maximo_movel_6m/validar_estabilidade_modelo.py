...
RELATORIO_TEXTO = Path("reports/versoes/maximo_movel_6m/resumo_estabilidade_modelo.txt")
RELATORIO_JSON = Path("reports/versoes/maximo_movel_6m/metricas_estabilidade_modelo.json")
